...
INSERT INTO vendor (id, vendor_name, vendor_baseurl, vendor_spec_id, vendor_service_class) VALUES ('v1', 'BrAPI Test Server (Vendor)', 'https://test-server.brapi.org/brapi/v1/', 'vs1', 0);
...
INSERT INTO vendor (id, vendor_name, vendor_baseurl, vendor_spec_id, vendor_service_class) VALUES ('v2', 'Localhost Test Server', 'http://localhost:8080/brapi/v1/', 'vs2', 0);
...
INSERT INTO genotype_db (id, genotype_db_name, genotype_db_baseurl, genotype_db_service_class) VALUES ('g1', 'BrAPI Test Server (Genotype DB)', 'https://test-server.brapi.org/brapi/v1/', 0);
INSERT INTO genotype_db (id, genotype_db_name, genotype_db_baseurl, genotype_db_service_class) VALUES ('g2', 'GOBii GDM Test Server', 'https://test-server.brapi.org/brapi/v1/', 1);
